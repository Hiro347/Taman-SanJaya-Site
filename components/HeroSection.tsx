    ...
    <section id="home" className="w-full pt-0 sm:pt-1 pb-0 flex flex-col justify-between overflow-hidden relative">
      ...
      <div className="w-full px-2 sm:px-4 lg:px-6">
        ...
        >
          ...
          {/* ================================================================= */}
          <div className="relative z-10 flex flex-col items-center text-center my-auto py-1 sm:py-4 max-w-4xl mx-auto">
          ...
          {/* ================================================================= */}
          <div className="relative z-10 flex flex-row items-center justify-between gap-2 pt-1.5 sm:pt-3 border-t border-white/15 text-white">
      ...
      <motion.div
        ...
        className="w-full relative -mt-5 sm:-mt-10 lg:-mt-14 pointer-events-none select-none z-10"
      >
        <div className="w-full scale-[1.04] translate-x-1.5 sm:translate-x-3 lg:translate-x-4 origin-center transform-gpu">
          <picture>

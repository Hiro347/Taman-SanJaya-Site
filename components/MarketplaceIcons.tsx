 ...
 * Signature green speech bubble with white telephone handset.
 */
export function WhatsAppIcon({
  ...
  phoneColor = '#FFFFFF',
  ...props
}: IconProps & { bubbleColor?: string; phoneColor?: string }) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path
        fill={bubbleColor}
        d="M12.004 2C6.48 2 2 6.48 2 12.004c0 1.804.484 3.518 1.328 5.006L2 22l5.12-1.343a9.96 9.96 0 0 0 4.884 1.275c5.524 0 10.004-4.48 10.004-10.004 0-5.524-4.48-10.004-10.004-10.004z"
      />
      {/* White Phone Handset */}
      <path
        fill={phoneColor}
        d="M17.472 14.382c-.301-.15-1.781-.878-2.057-.978-.276-.1-.476-.15-.677.15-.2.3-.777.978-.952 1.179-.176.2-.351.226-.652.075-1.03-.516-1.92-1.077-2.67-1.93-.574-.654-1.033-1.428-1.285-1.855-.176-.3-.019-.462.131-.612.136-.135.301-.351.451-.527.151-.175.201-.3.301-.5.1-.2.05-.376-.025-.526-.075-.15-.677-1.633-.928-2.236-.244-.588-.493-.508-.677-.518-.175-.008-.376-.01-.577-.01-.2 0-.526.075-.802.376-.276.3-1.053 1.028-1.053 2.508 0 1.48 1.078 2.909 1.229 3.11.15.2 2.122 3.24 5.141 4.544.718.31 1.278.496 1.716.634.721.23 1.378.197 1.897.12.578-.087 1.781-.728 2.032-1.431.25-.703.25-1.305.175-1.43-.075-.126-.276-.201-.577-.351z"
      />
    </svg>
  );
}
